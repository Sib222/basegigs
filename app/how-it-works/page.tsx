    ...
    <div className="min-h-screen bg-sage">
      ...
      <div className="bg-gradient-to-b from-primary-light to-sage py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold text-secondary mb-4">Simple. Secure. Seamless.</h1>
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Link href="/browse-gigs" className="px-8 py-3 bg-white text-secondary border-2 border-secondary rounded-lg text-lg font-semibold hover:bg-secondary hover:text-white transition-colors">
              Browse Gigs
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-16 reveal opacity-0">
          <h3 className="text-3xl font-bold text-center mb-4 text-secondary">For Clients</h3>
        ...
        <div className="border-t-2 pt-16 reveal opacity-0">
          <h3 className="text-3xl font-bold text-center mb-4 text-secondary">For Gig Seekers</h3>
      ...
      <div className="bg-white py-16 reveal opacity-0">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-3xl font-bold text-center mb-12 text-secondary">Why Choose BaseGigs?</h3>
      ...
      <div className="bg-secondary text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200">Join thousands of clients and gig seekers already using BaseGigs to connect, collaborate, and get things done.</p>
          <div className="flex justify-center space-x-4">
            <Link href="/signup" className="px-8 py-3 bg-primary text-white rounded-lg text-lg font-semibold hover:bg-primary-dark transition-colors">
              Create Account
            </Link>
            <Link href="/browse-gigs" className="px-8 py-3 bg-white text-secondary rounded-lg text-lg font-semibold hover:bg-gray-100 transition-colors">
              Browse Gigs
            </Link>
          </div>

          {/* New Subscription Info Section */}
          <div className="mt-12 max-w-2xl mx-auto bg-white bg-opacity-10 rounded-lg p-6 border border-white/30">
