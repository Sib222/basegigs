...
<Link href="/post-gig" className="p-6 border-2 border-gray-300 rounded-lg hover:bg-gray-50 text-center">
<h3 className="text-xl font-semibold mb-2">Post a Gig</h3>
<p className="text-gray-600">Create a new gig listing to find talent</p>
</Link>
<Link href="/find-talent" className="p-6 border-2 border-gray-300 rounded-lg hover:bg-gray-50 text-center">
<h3 className="text-xl font-semibold mb-2">Find Talent</h3>
<p className="text-gray-600">Browse verified gig seekers</p>
</Link>
<Link href="/browse-gigs" className="p-6 border-2 border-gray-300 rounded-lg hover:bg-gray-50 text-center">
...
We&apos;re building out the full dashboard features. You can now view applications!
Post Gig functionality will be available soon!
</p>
</div>
</div>
</div>
