    ...
    <div className="min-h-screen bg-sage">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-2xl shadow-sm p-8 space-y-10">
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">1. What BaseGigs Is</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">2. Eligibility</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">3. Accounts</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">4. Gig Postings</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">5. Payments Between Users</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">6. Platform Fees</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">7. Contracts</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">8. User Conduct</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">9. Limitation of Liability</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">10. Intellectual Property</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-secondary mb-3">12. Changes to These Terms</h2>
